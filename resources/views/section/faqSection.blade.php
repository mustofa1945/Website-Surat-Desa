<section class="flex flex-col p-6 md:w-[70%] w-full pb-[10vh]">
    <!-- Child Pertama: h1 -->
    <div class="lg:container lg:mx-auto lg:py-16 md:py-12 md:px-6 py-12 px-4">
        <h1 class="text-center dark:text-white lg:text-4xl text-3xl lg:leading-9 leading-7 text-[#FF2E63] font-semibold">
            FAQ's</h1>
    ...
    <!-- Accordion -->
    <div
        class="w-full divide-y divide-[#252A34]  overflow-hidden rounded-xl border border-slate-300 bg-slate-100/40 text-slate-700 dark:divide-slate-700 dark:border-slate-700 dark:bg-slate-800/50 dark:text-slate-300">
        <div x-data="{ isExpanded: false }" class="divide-y divide-[#252A34] dark:divide-slate-700">
