<section class="md:mx-auto md:px-6 md:w-[90%] md:py-16 md:items-center md:flex flex-col">
    ...
    <div class="grid md:grid-cols-4 md:grid-rows-4 grid-cols-1 grid-rows-10 md:gap-0 gap-3 bg-sky-500">

        

        {{-- Div Pertama --}}
        <div class="md:col-span-2 md:row-span-2 row-span-2  md:flex  md:items-end flex justify-center  md:justify-start items-end h-full">
            @if (isset($color))
        ...
        <div class="md:col-span-2 md:row-span-4 bg-rose-500">
            <img src="{{ $image }}" alt="Sample Image" class="rounded-lg shadow-lg w-full md:w-3/4">
        </div>


        <div class=" md:row-span-2  md:col-span-2 row-span-4 flex flex-col">
