    ...
    <!-- Pop-up Konfirmasi -->
    <div id={{ $id }}" class="inset-0 flex justify-center items-center w-full h-full bg-black bg-opacity-50  justify-center items-center">
        <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
            <h2 class="text-xl font-bold mb-4">Konfirmasi</h2>
            <p class="text-gray-700 mb-6">Apakah Anda yakin ingin {{ $text }} data ini?</p>
