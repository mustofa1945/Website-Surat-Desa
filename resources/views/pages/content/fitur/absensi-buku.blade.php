    ...
    <div class="w-full px-2 md:px-[10rem]">
        ...
        <div class="mt-[100px]">
            @include('components.fitur.imageTextSectionRight', [
                ...
                'text' => "Absensi perangkat desa masih pakai lembaran kertas atau finger print? Juga buku tamu masih pakai buku folio. Kini hadir dengan terobosan baru, menyatukan Absensi Perangkat Desa & Buku Tamu dalam satu layanan, Absensi & Buku Tamu Digital. . Melalui fitur ini, Anda dapat dengan mudah mencatat 
                          kehadiran dan kunjungan dengan lebih terperinci dan akurat. Absensi dan Buku Tamu digital dilengkapi dengan pembaca E-KTP, memungkinkan pemantauan yang lebih baik terhadap kehadiran dan ketidakhadiran aparat desa.",
        ...
        <div class="grid  w-full  mt-[10rem]">
            <div class="w-full flex flex-col gap-y-[10vh]">
                <h2 class="text-2xl md:text-3xl font-bold place-self-center text-[#FF2E63]">Fitur Absensi dan Buku Tamu</h2>
                {{-- Kolom Kedua --}}

                @include('components.fitur.imageTextSectionLeft', [
                    'title' => 'Absensi',
                    'text' => 'Melalui fitur ini, kehadiran Perangkat Desa dapat dimonitoring dengan mudah. Anda juga dapat melihat statistik kehadiran dan dapat dicetak sebagai laporan kehadiran.',
                    'image' => asset('images/desa5.jpg'),
                ])
