    <header class=" z-50 fixed w-full md:h-[3.5rem] top-0 bg-green-500 bg-opacity-50  shadow-lg flex md:flex-row flex-col md:justify-center md:px-2">
            ...
            <nav class=" md:w-1/2 w-full md:h-full h-[85%] hidden md:block flex justify-center items-center md:p-2  bg-opacity-50  menu">
                <ul class="flex flex-col md:flex-row md:space-x-8 md:items-center text-white font-medium w-full h-full md:gap-0 gap-y-3 md:justify-start justify-around md:px-0 px-5">
                    ...
                    <li class="list md:hidden block">fitur
                        <div class="list-fitur hidden py-3 text-gray-700 dark:text-gray-400 text-sm w-full">
