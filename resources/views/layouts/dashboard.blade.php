...
<body class="relative bg-gray-100 flex justify-end">

    <div class="relative flex w-[82.4%]">
        <div
            class="fixed  left-0 top-0 flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-[calc(104vh-2rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5">
            <div class="mb-2 p-4">
            ...
            <nav class="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
                <div role="button" tabindex="0"
                    ...
                    <a href="{{ route('dashboard.data-user') }}">Data</a>
                </div>
                <div role="button" tabindex="0"
                    ...
                    <a href="{{ route('dashboard.data-artikel') }}">Artikel</a>
                </div>
                <div role="button" tabindex="0"
                    class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                    <div class="grid place-items-center mr-4">
                    ...
                    <a href="{{ route('dashboard.notification') }}">Notif</a>
                ...
                <div role="button" tabindex="0"
                    class="flex items-center trigger-logout w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                    <div class="grid place-items-center mr-4 ">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"
                            class="h-5 w-5">
                            <path fill-rule="evenodd"
            ...
            <main class=" w-full top-0">
                <!-- Header -->
                <header class="fixed top-0 w-full bg-white shadow px-6 py-4 flex justify-between items-center">
...
#                </div>
    ...
    {{-- Logout --}}
    <div class=" fixed button-logout  top-0 hidden left-0 w-full h-full">
        @include('components.button.popup-button-logout', [
            'text' => 'Logout',
            'choise' => 'Oke',
            'color' => 'red',
        ])
